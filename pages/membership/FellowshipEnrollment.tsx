    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-6">
        ...
        >
          ...
          <h2 className="text-4xl font-serif-vintage italic mb-6">{t('success.title')} <span className="text-amber-500">{t('success.titleHighlight')}</span></h2>
  ...
  return (
    <div className="pt-20 px-6 max-w-5xl mx-auto pb-40 relative">
      ...
      <div className="text-center mb-20 relative z-10">
        ...
        <h1 className="text-5xl md:text-8xl font-serif-vintage italic mb-6">{t('header.title')} <span className="text-amber-600">{t('header.titleHighlight')}</span></h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-12 relative z-10">
        ...
        >
          <div className="flex items-center gap-4 mb-10">
            ...
            <h3 className="text-2xl font-serif-vintage italic">{t('sections.identity.title')} <span className="text-amber-500">{t('sections.identity.titleHighlight')}</span></h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-amber-500 font-bold ml-1">{t('sections.identity.legalName')}</label>
              <input type="text" required placeholder={t('sections.identity.legalNamePlaceholder')} className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 focus:outline-none focus:border-amber-500/50 transition-all text-sm italic" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-amber-500 font-bold ml-1">{t('sections.identity.spiritualName')}</label>
              <input type="text" placeholder={t('sections.identity.spiritualNamePlaceholder')} className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 focus:outline-none focus:border-amber-500/50 transition-all text-sm italic" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-amber-500 font-bold ml-1">{t('sections.identity.email')}</label>
              <input type="email" required placeholder={t('sections.identity.emailPlaceholder')} className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 focus:outline-none focus:border-amber-500/50 transition-all text-sm" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-amber-500 font-bold ml-1">{t('sections.identity.tier')}</label>
        ...
        >
          <div className="flex items-center gap-4 mb-10">
            ...
            <h3 className="text-2xl font-serif-vintage italic">{t('sections.influence.title')} <span className="text-amber-500">{t('sections.influence.titleHighlight')}</span></h3>
          </div>

          <div className="space-y-8">
            <div className="space-y-4">
              <label className="text-[10px] uppercase tracking-widest text-amber-500 font-bold ml-1">{t('sections.influence.pillars')}</label>
              <div className="flex flex-wrap gap-4">
                {['education', 'shelter', 'health', 'innovation', 'spiritualLife', 'selfEmpowerment'].map((pillar) => (
                  <label key={pillar} className="flex items-center gap-3 cursor-pointer group">
                    ...
                    <span className="text-xs text-gray-400 uppercase tracking-widest group-hover:text-white transition-colors">{t(`pillars.${pillar}`)}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-amber-500 font-bold ml-1">{t('sections.influence.skills')}</label>
              <input type="text" placeholder={t('sections.influence.skillsPlaceholder')} className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 focus:outline-none focus:border-amber-500/50 transition-all text-sm italic" />
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-4 mb-10">
            ...
            <h3 className="text-2xl font-serif-vintage italic">{t('sections.dharma.title')} <span className="text-amber-500">{t('sections.dharma.titleHighlight')}</span></h3>
          </div>

          <div className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-amber-500 font-bold ml-1">{t('sections.dharma.motivation')}</label>
              <textarea 
                rows={6} 
                required
        ...
        <div className="pt-8">
          ...
          >
            {t('submit')} <ArrowRight size={20} className="group-hover:translate-x-2 transition-transform" />
          </button>
        </div>
      </form>
