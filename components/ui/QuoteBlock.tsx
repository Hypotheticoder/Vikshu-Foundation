...
const QuoteBlock: React.FC<QuoteBlockProps> = ({ 
  ...
  return (
    <motion.div 
      ...
      style={variant === 'paper' ? { backgroundImage: `url(public/assets/background.png)`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' } : undefined}
    >
